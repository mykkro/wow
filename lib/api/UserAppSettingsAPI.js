...
var _userAppSettingsDAO = null
var userAppSettingsDAO = function() {
	if(!_userAppSettingsDAO) 
		_userAppSettingsDAO = require("../dao/UserAppSettingsDAO")
	return new (_userAppSettingsDAO)
}
