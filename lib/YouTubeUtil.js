 ...
 */
var YouTubeUtil = {
  urlFromId: function(ytId) {
    return "http://www.youtube.com/watch?v="+ytId
  },
  thumbFromId: function(ytId) {
    return "http://i3.ytimg.com/vi/" + ytId + "/default.jpg"
  },
  /**
  ...
  wrapItem: function(data) {
    ...
    var out = {
      ...
      url: this.urlFromId(ytId),
      thumbnailUrl: this.thumbFromId(ytId)
    }
    if(data.statistics) {
  ...
  /**
   * ## YouTubeUtil.info
   * Retrieves information about a YouTube video based on its YouTube ID.
