(function($) {
    ...
    Alpaca.Fields.MyTextAreaField = Alpaca.Fields.TextField.extend(
    /**
     * @lends Alpaca.Fields.MyTextAreaField.prototype
     */
    {
        /**
         * @constructs
        ...
        getDescription: function() {
            return "Custom Textarea field for multiple line text.";
        },
