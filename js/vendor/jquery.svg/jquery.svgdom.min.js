...
(function($) {
    ...
    if ($.cssProps) {
        $.css = function(e) {
            return function(a, b, c) {
                var d = (b.match(/^svg.*/) ? $(a).attr($.cssProps[b] || b) : '');
                return d || e(a, b, c)
            }
        }($.css)
    }
    ...
    $.expr.find.ID = function(d) {
        return function(a, b, c) {
            return ($.svg.isSVGElem(b) ? [b.ownerDocument.getElementById(a[1])] : d(a, b, c))
        }
    }($.expr.find.ID);
    ...
    $.expr.preFilter.CLASS = function(a, b, c, d, f, g) {
        ...
        for (var i = 0, elem = {}; elem != null; i++) {
            ...
            if (elem) {
                var h = (!$.svg.isSVGElem(elem) ? elem.className : (elem.className ? elem.className.baseVal : '') || elem.getAttribute('class'));
    ...
    $.expr.filter.CLASS = function(a, b) {
        var c = (!$.svg.isSVGElem(a) ? a.className : (a.className ? a.className.baseVal : a.getAttribute('class')));
