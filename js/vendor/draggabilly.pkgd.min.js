    ...
    function i(t) {
        function i(t) {
            if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                for (var d = o.isBorderBox = !(!u || !i[u] || "border-box" !== i[u]), f = 0, c = s.length; c > f; f++) {
                    var p = s[f],
                        l = i[p];
                    l = a(t, l);
                    var g = parseFloat(l);
                ...
                var w = e(i.height);
                return w !== !1 && (o.height = w + (L ? 0 : m + b)), o.innerWidth = o.width - (v + x), o.innerHeight = o.height - (m + b), o.outerWidth = o.width + y, o.outerHeight = o.height + E, o
            }
        }
...
function(t) {
    ...
    function i(i, o, s, u, d) {
        ...
        e(c.prototype, o.prototype), c.prototype.options = {}, c.prototype._create = function() {
            ...
            for (var t = 0, e = this.handles.length; e > t; t++) {
                ...
                s.bind(n, "mousedown", this), s.bind(n, "touchstart", this), E(n)
            }
        };
        ...
        c.prototype._getPosition = function() {
            ...
            var n = this.dragPoint.x - this.startPoint.x,
                ...
                r = o && o[0],
                s = o && o[1];
            if (n = g(n, r), i = g(i, s), this.options.containment) {
                var a = this.relativeStartPosition.x,
                    h = this.relativeStartPosition.y,
                    u = g(-a, r, "ceil"),
                    d = g(-h, s, "ceil"),
                    f = this.containerSize.width - a - this.size.width,
                    c = this.containerSize.height - h - this.size.height;
                f = g(f, r, "floor"), c = g(c, s, "floor"), n = Math.min(f, Math.max(u, n)), i = Math.min(c, Math.max(d, i))
            }
            n = "y" === this.options.axis ? 0 : n, i = "x" === this.options.axis ? 0 : i, this.position.x = this.startPosition.x + n, this.position.y = this.startPosition.y + i, this.dragPoint.x = n, this.dragPoint.y = i, this.emitEvent("dragMove", [this, t, e])
        ...
        return c.prototype.setLeftTop = function() {
            ...
            this.element.style[v] = x(this.dragPoint.x, this.dragPoint.y)
    ...
    for (var o, r = t.document, s = r.defaultView, a = s && s.getComputedStyle ? function(t) {
        ...
        }, u = 0, d = "webkit moz ms o".split(" "), f = t.requestAnimationFrame, c = t.cancelAnimationFrame, p = 0; d.length > p && (!f || !c); p++) o = d[p], f = f || t[o + "RequestAnimationFrame"], c = c || t[o + "CancelAnimationFrame"] || t[o + "CancelRequestAnimationFrame"];
    f && c || (f = function(e) {
