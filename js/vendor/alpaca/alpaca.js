    ...
    (function($) {
        ...
        Validator = {
            ...
            validate: function( /*Any*/ instance, /*Object*/ schema) {
                return Validator._validate(instance, schema, {
                    changing: false
            ...
            checkPropertyChange: function( /*Any*/ value, /*Object*/ schema, /*String*/ property) {
                return Validator._validate(value, schema, {
 ...
 */
    ...
    (function($) {
        ...
        Alpaca.registerView({
            ...
            "templates": {
                ...
                "controlFieldMessage": '<div><span class="ui-icon ui-icon-alert"></span><span class="alpaca-controlfield-message-text">${message}</span></div>',
                "controlFieldHelper": '{{if options.helper}}<div class="{{if options.helperClass}}${options.helperClass}{{/if}}"><span class="ui-icon ui-icon-info"></span><span class="alpaca-controlfield-helper-text">${options.helper}</span></div>{{/if}}',
                "controlField": '{{html Alpaca.fieldTemplate(this,"controlFieldLabel")}}' +
    ...
    (function($) {
        ...
        Alpaca.registerView({
            "id": "VIEW_WEB_EDIT",
            "templates": {
                "twoColumnLayout": '<div class="alpaca-layout-two-column-mask">' + '{{if options.label}}<h3>${options.label}</h3>{{/if}}' + '{{if options.helper}}<h4>${options.helper}</h4>{{/if}}' + '<div class="alpaca-layout-two-column-left alpaca-layout-region"  id="leftcolumn"></div>' + '<div class="alpaca-layout-two-column-right alpaca-layout-region" id="rightcolumn"></div>' + '</div>'
            }
        });
    ...
    (function($) {
        ...
        Alpaca.ControlField = Alpaca.Field.extend(
             ...
             */
            {
                 ...
                 */
                onClick: function(e) {}, //__BUILDER_HELPERS
    ...
    (function($) {
        ...
        Alpaca.ContainerField = Alpaca.Field.extend(
             ...
             */
            {
                 ...
                 */
                renderItems: function(onSuccess) {}, //__BUILDER_HELPERS
        ...
        Alpaca.Form = Base.extend(
             ...
             */
            {
                ...
                enableSubmitButton: function() {
                    ...
                    if ($.mobile) {
                        try {
                            $(".alpaca-form-button-submit").button('refresh');
                        } catch (e) {}
                    }
                },
                        ...
                        if (itemToolbarTemplateDescriptor) {
                            ...
                            for (var i in buttonsDef) {
                                (function(def) { // closure to prevent "def" leaking
                                    ...
                                    el.click(function(e) {
                                        return def.clickCallback(id, _this, e);
                                    });
             ...
             */
            {
                ...
                setup: function() {
                    ...
                    var holdings = Alpaca.retrieveUSHoldings(
                        ...
                        this.options.includeTerritories, (this.options.format == "code"),
