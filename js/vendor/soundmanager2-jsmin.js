...
(function(k, g) {
    function fa(fa, wa) {
        ...
        ra = function(b) {
            var d;
            b && (d = ua ? "about:blank" : c.html5.canPlayType("audio/wav") ? "data:audio/wave;base64,/UklGRiYAAABXQVZFZm10IBAAAAABAAEARKwAAIhYAQACABAAZGF0YQIAAAD//w\x3d\x3d" : "about:blank", b.src = d, void 0 !== b._called_unload && (b._called_load = !1));
            E && (Ma = null);
            return d
        };
        ca = function(b) {
        ...
        la = function(b, d) {
            ...
            if (L) f = p.createElement("div"), s = ['\x3cobject id\x3d"' + b + '" data\x3d"' + d + '" type\x3d"' + h.type + '" title\x3d"' + h.title + '" classid\x3d"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase\x3d"' + pb + 'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version\x3d6,0,40,0"\x3e', a("movie", d), a("AllowScriptAccess", c.allowScriptAccess), a("quality", h.quality), c.wmode ?
                a("wmode", c.wmode) : "", a("bgcolor", c.bgColor), a("hasPriority", "true"), c.debugFlash ? a("FlashVars", h.FlashVars) : "", "\x3c/object\x3e"
            ].join("");
            else
            ...
            if (h = ka())
                if (c.oMC = A(c.movieID) || p.createElement("div"), c.oMC.id) q = c.oMC.className, c.oMC.className = (q ? q + " " : "movieContainer") + (l ? " " + l : ""), c.oMC.appendChild(f), L && (n = c.oMC.appendChild(p.createElement("div")), n.className = "sm2-object-box", n.innerHTML = s), W = !0;
                    ...
                    try {
                        L || c.oMC.appendChild(f), h.appendChild(c.oMC), L && (n = c.oMC.appendChild(p.createElement("div")),
        ...
        kb = function() {
            ...
            var b, d = [];
            if (c.useHTML5Audio && c.hasHTML5) {
                for (b in c.audioFormats) c.audioFormats.hasOwnProperty(b) && d.push(b + " \x3d " + c.html5[b] + (!c.html5[b] && z && c.flash[b] ? " (using flash)" : c.preferFlash && c.flash[b] && z ? " (preferring flash)" : !c.html5[b] ? " (" + (c.audioFormats[b].required ?
        ...
        R = function() {
            ...
            var b = null,
                b = null,
                d = U.toLowerCase(); - 1 !== d.indexOf("sm2-usehtml5audio\x3d") && (b = "1" === d.charAt(d.indexOf("sm2-usehtml5audio\x3d") +
