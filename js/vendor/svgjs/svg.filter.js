...
(function() {
    ...
    SVG.extend(SVG.Filter, {
        ...
        put: function(element, i) {
            ...
            return element.attr({ in : this.source,
                result: element
            })
        }
        // Blend effect
        ...
        blend: function(in1, in2, mode) {
            return this.put(new SVG.BlendEffect).attr({ in : in1,
                in2: in2,
                mode: mode || 'normal'
            })
        }
        ...
        composite: function(in1, in2, operator) {
            return this.put(new SVG.CompositeEffect).attr({ in : in1,
                in2: in2,
                operator: operator
            })
        }
    ...
    var effects = [
        'blend', 'colorMatrix', 'componentTransfer', 'composite', 'convolveMatrix', 'diffuseLighting', 'displacementMap', 'flood', 'gaussianBlur', 'image', 'merge', 'morphology', 'offset', 'specularLighting', 'tile', 'turbulence', 'distantLight', 'pointLight', 'spotLight'
    ]
