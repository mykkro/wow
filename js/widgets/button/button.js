module.exports = function(Widgetizer) {
	...
	var factory = function(element, done) {
		...
		var tspanElement = SvgHelper.tspan(text, {"font-size": attrs.fontSize+"px"})
		textElement.appendChild(tspanElement)
		var iconElement = SvgHelper.image({"width":attrs.iconSize, "height": attrs.iconSize, "class":"wow-button-icon", "src":attrs.icon}) 
